...
const Dropdown = ({
  ...
  const dynamicPlaceholder = isOpen && selectedOption
        ...
        <div className="relative w-full">
          <input
            ...
            className={`
              ...
              focus:ring-[0.5px] focus:border-0 focus:ring-[#560fd1] focus:outline-none
                  ...
                  filteredOptions.map((option, index) => (
                    ...
                    >
                      ...
                      {showCheckmark && value === option.value && (
                        <Check className="h-4 w-4 text-[#560fd1] flex-shrink-0" />
                      )}
                    </button>
                  ))
                ) : (
